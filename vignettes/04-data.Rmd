...
```
    ...
    ##           [,1]      [,2]
    ## [1,] 0.6524642 0.5814884
    ## [2,] 0.8188188 0.4809762
    ## [3,] 0.3718168 0.5736178
...
The `as_cpumat()` offers a shorthand for this operation, so you do not
have to manually create the skeleton object:
